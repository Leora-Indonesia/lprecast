...
- Name: vendor-register.spec.ts >> Vendor Registration Flow >> Step 4: Review & Submit >> should show validation error when legal agreement not checked
- Location: e2e/vendor-register.spec.ts:177:5
