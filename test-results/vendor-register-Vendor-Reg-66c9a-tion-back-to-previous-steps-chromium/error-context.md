...
- Name: vendor-register.spec.ts >> Vendor Registration Flow >> Step 4: Review & Submit >> should allow navigation back to previous steps
- Location: e2e/vendor-register.spec.ts:188:5
...
```ts
  23  |   siup_file?: Buffer
  24  |   compro_file?: Buffer
  25  | }
  26  | 
  27  | export interface BankData {
  28  |   bank_nama: string
  29  |   bank_nomor: string
  30  |   bank_atas_nama: string
  31  | }
  32  | 
  33  | export interface FactoryAddressData {
  34  |   alamat_detail: string
  35  |   provinsi_id: string
  36  |   kabupaten_id: string
  37  |   kecamatan: string
  38  |   kode_pos: string
  39  | }
  40  | 
  41  | export interface ProductData {
  42  |   name: string
  43  |   satuan: string
  44  |   price: number
