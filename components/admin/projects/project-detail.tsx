      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button
              variant={project.status === "draft" ? "outline" : "default"}
              asChild
            >
        ...
        <div className="flex flex-wrap gap-2">
          <Button
            type="button"
            variant={activeAudience === "client" ? "default" : "outline"}
      ...
      <Card>
        ...
        <CardContent className="flex flex-wrap items-center gap-3 text-sm text-muted-foreground">
          ...
          <span>
            {project.status === "open"
              ? "UI label: Tendering."
              : "Ubah data hanya lewat tombol Edit Project."}
          </span>
        </CardContent>
      </Card>
            ...
            <>
              <Card>
                ...
                <CardContent className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      <CalendarRange className="h-4 w-4" /> Periode Kerja
                    </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Client profile: {project.client_profile_id || "-"} ·
                      Client user: {project.client_id || "-"}
                    </p>
                  </div>
                  <div className="space-y-1">
              ...
              <ProjectAttachments
                ...
                initialAttachments={project.attachments}
                readOnly
              />
            </>
          ) : null}
            ...
            <>
              <Card>
                ...
                <CardContent className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-1">
                    <p className="text-sm text-muted-foreground">Provinsi ID</p>
                    <p className="font-medium">{project.province_id || "-"}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm text-muted-foreground">
                      Kota / Kabupaten ID
                    </p>
                    <p className="font-medium">{project.city_id || "-"}</p>
                  </div>
                  <div className="space-y-1 md:col-span-2">
                    <p className="text-sm text-muted-foreground">
                      Koordinat lokasi
              ...
              <Card>
                ...
                <CardContent className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-1">
                    ...
                    <p className="font-medium">{project.job_type || "-"}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm text-muted-foreground">
                      Estimasi volume
                    ...
                    <p className="font-medium">
                      {project.estimated_length_or_area ?? "-"}{" "}
                      {project.measurement_unit || ""}
                    </p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm text-muted-foreground">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="font-medium">
                      {project.foundation_preference || "-"}
                    </p>
                  </div>
                  <div className="space-y-1 md:col-span-2">
                    <p className="text-sm text-muted-foreground">
                      Deskripsi kebutuhan awal
                    </p>
                    <p className="font-medium whitespace-pre-wrap">
              ...
              <Card>
                ...
                <CardContent className="space-y-4 text-sm text-muted-foreground">
                  <div className="rounded-lg border bg-muted/20 p-4">
                    Toggle SPV dipisah dulu untuk menjaga lane operasional tetap
                    jelas. Area ini akan menampung Kurva S baseline, schedule,
                    dan readiness pre-con.
                  </div>
                  <ul className="list-disc space-y-2 pl-5">
                    <li>SPV hanya operasional, tidak melihat payment lane.</li>
                    <li>
                      Data lokasi dan site condition jadi bekal awal verifikasi
                      lapangan.
                    </li>
                    <li>
                      Milestone operasional bisa dipantau dari panel samping.
                    </li>
                  </ul>
                </CardContent>
              </Card>
