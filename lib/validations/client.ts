...
export const clientProjectIntakeSchema = z
  .object({
    ...
    estimated_length_or_area: numericStringSchema.refine(
    ...
    target_completion_date: dateFieldSchema.refine(
      (value) => value.length > 0,
      {
    ...
    initial_description: z
      .string()
      .trim()
      .min(1, "Deskripsi kebutuhan awal wajib diisi"),
