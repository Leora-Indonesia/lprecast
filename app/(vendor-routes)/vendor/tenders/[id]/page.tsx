    ...
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <Button disabled>Ajukan Penawaran — segera tersedia</Button>
        </div>
      </div>
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,2fr)_minmax(320px,1fr)]">
        <div className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Ringkasan Tender</CardTitle>
            </CardHeader>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Aturan Tender</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-sm">
              ...
              <div className="flex items-center justify-between gap-3">
                <span className="text-muted-foreground">Batas submit</span>
                <span>
                  {formatSubmissionDeadline(tender.submission_deadline_at)}
                </span>
              </div>
              <div className="flex items-center justify-between gap-3">
                <span className="text-muted-foreground">Deadline revisi</span>
                <span>
              ...
              <div className="rounded-lg border bg-muted/20 p-3 text-muted-foreground">
                Penawaran vendor akan memakai item tender ini. Nilai SPK
                mengikuti harga tender x quantity setelah vendor dipilih.
              </div>
            </CardContent>
          </Card>
        </div>
